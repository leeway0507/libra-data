...
DROP COLUMN book_count;

ALTER TABLE Libraries
RENAME COLUMN lib_address TO address;
ALTER TABLE Libraries
RENAME COLUMN longtitude TO longitude;
ALTER TABLE books 
DROP COLUMN Set_ISBN;
...
ALTER TABLE libraries
ADD COLUMN book_count INTEGER;

ALTER TABLE Libraries
RENAME COLUMN address TO lib_address;

ALTER TABLE Libraries
RENAME COLUMN longitude TO longtitude;

ALTER TABLE books
ADD Set_ISBN VARCHAR(255);
